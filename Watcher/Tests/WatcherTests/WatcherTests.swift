import XCTest
@testable import DataDogWatcher

final class DataDogWatcherTests: XCTestCase {
    func testExample() throws {
        let cpuLoad = CPULoadWatcher().hostCPULoadInfo()
        print(cpuLoad)
        let usage = MyCpuUsage()
        print(usage)
        
        let ex = expectation(description: "usage")
